...
public final class AutoRpmConfig {
    ...
    public static double NEAR_DIST_IN      = 51;  // Authoritative near-shot distance (inches); overrides controller defaults
    public static double NEAR_RPM          = 4500.0; // RPM paired with NEAR_DIST_IN; adjust together after re-scaling range
