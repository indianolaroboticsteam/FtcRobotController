...
public class Auto_Blue_Human extends BaseAuto {
    ...
    public Auto_Blue_Human() { setStartingPose(-12.0, 0.0, 0.0); }
    ...
    protected void runSequence() throws InterruptedException {
        sequence()
                ...
                .rotateToTarget("Scan for Tag", ScanDirection.CCW, 0.75, 90, 30, 10000)
                ...
                .move("Drive 36 in back", 36.0, 180.0, 0.0, 0.85)
                .run();
    }
}
